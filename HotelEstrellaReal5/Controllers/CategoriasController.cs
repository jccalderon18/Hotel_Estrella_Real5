...
namespace HotelEstrellaReal5.Controllers
{
    public class CategoriasController : BaseController
    {
        ...
        public CategoriasController(HotelEstrellaReal5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,Nombre,Descripcion")] Categoria categoria)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["ResultOk"] = "! Categoria Creada Exitosamente !";
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["ResultOk"] = "! Categoria Eliminada Exitosamente !";
            return RedirectToAction(nameof(Index));
        }
