...
namespace HotelEstrellaReal5.Controllers
{
    public class PermisosController : BaseController
    {
        ...
        public PermisosController(HotelEstrellaReal5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPermiso,Nombre,Descripcion")] Permiso permiso)
        {
            if (ModelState.IsValid)
            {
                _context.Add(permiso);
                await _context.SaveChangesAsync();
                TempData["ResultOk"] = "! Permiso Creado Exitosamente !";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPermiso,Nombre,Descripcion")] Permiso permiso)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["ResultOk"] = "! Permiso Eliminado Exitosamente !";
            return RedirectToAction(nameof(Index));
        }
